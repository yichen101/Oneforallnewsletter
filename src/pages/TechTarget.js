...
import classes from './TechTarget.module.css'
import '../App.css'
import PageList from '../components/PageList';
import MenuTab from '../components/MenuTab'
import ScrollToTop from '../components/ScrollToTop';

function TechTargetPage() {
  const [listOfArticles, setListOfArticles] = useState([])
  const [searchWord, setSearchWord] = useState("")
  
  //Pull TechTarget data
  useEffect (() => {
    Axios.get("https://news-firebase-8a2f0-default-rtdb.europe-west1.firebasedatabase.app/tt_data.json")
      .then((response) => {
...
<div className={classes.backgroundColor}>
      <ScrollToTop/>
      <img src='https://raw.githubusercontent.com/yichen101/Projectimages/main/images/tt_banner.jpg' alt='TT logo' className={classes.img}/>
        <div id ='mainContent'>
