...
import classes from './WallStreetJournal.module.css'
import '../App.css'
import PageList from '../components/PageList';
import MenuTab from '../components/MenuTab'
import ScrollToTop from '../components/ScrollToTop';

function WallStreetJournalPage() {
  ...
  return (
    ...
    <ScrollToTop/>
    <img src='https://raw.githubusercontent.com/yichen101/Projectimages/main/images/wsj_banner.jpg' alt='WSJ Logo' className={classes.img}/>
      <div id ='mainContent'>
...
export default WallStreetJournalPage;
